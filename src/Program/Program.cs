...
namespace Full_GRASP_And_SOLID
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            ConsolePrinter cp = new ConsolePrinter();   //ya no llamo con parametros de destino a printrecipe, sino que uso creo dos
            cp.PrintRecipe(recipe);                     //instancias uno para consola y otro para el archivo y llamo a printRecipe
